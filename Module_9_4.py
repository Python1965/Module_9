...
#       - write_everything(*data_set), где *data_set - параметр принимающий неограниченное количество
#         данных любого типа.
...
# Метод __call__:
#------------------
# Создайте класс MysticBall, объекты которого обладают атрибутом words хранящиv коллекцию строк.
